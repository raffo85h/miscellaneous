...
"""
#==============================================================================
#PROBLEM: Given a string we want to reverse each word in the string.
#==============================================================================
...
print reverse_words_string('hello world!')
print reverse_words_string('Example, with different characters. Need to test! Hello.')